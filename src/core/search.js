import { computeRecencyBoost } from "./scoring.js";
...
function classifyMatch(query, prompt) {
...
export function searchPrompts(query, limit) {
...
export function recordUsage(promptId) {
  usageCounter += 1;
